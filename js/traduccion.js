...
const translationsFreelance = {
  en: {
    freelance1Category: "Full-stack Website",
    freelance1Title: "DFS Studio",
    freelance2Category: "Redesign",
    freelance2Title: "Home Studio Chiesa",
  },
  es: {
    freelance1Category: "Página web Full-stack",
    freelance1Title: "DFS Estudio",
    freelance2Category: "Rediseño",
    freelance2Title: "Home Estudio Chiesa",
  },
};
...
function translateFreelance(lang) {
  ...
  document.getElementById("freelance-2-category").textContent = translationsFreelance[lang].freelance2Category;
  document.getElementById("freelance-2-title").textContent = translationsFreelance[lang].freelance2Title;
}
